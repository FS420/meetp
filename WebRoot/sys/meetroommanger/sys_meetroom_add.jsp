...
<html>
	<head>
  	...
  	<body background="${path}/img/picture3.jpg">
		...
		<form action="${path}/meetRoom/insert.action" method="post">
			<div class="diyihang">
				<div class="huiyishi_left">会议室名称</div>
				<input type="text" name="roomname" class="input_update"  />
		 	</div>
			<div class="hang">
				<div class="huiyishi_left">位置</div>
				<input type="text" name="roomplace" class="input_update" />
			</div>
			<div class="hang">
				<div class="huiyishi_left">容量</div>
				<input type="text" name="holdnumber" class="input_update"/>
			</div>
			<div class="hang">
				<div class="huiyishi_left">是否可用</div>
				<div class="meetroommanage_isable">
					<input type="radio" name="isable" checked="checked"/>是
					<input type="radio" name="isable" />否
				</div>
			</div>
			<div class="beizhu">
				<div class="beizhu_left">备注</div>
				<textarea rows="20" cols="10" name="memo" class="input_update" style="width:235px; height:70px"></textarea>
			</div>
