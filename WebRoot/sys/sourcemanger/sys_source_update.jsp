...
<html>
	<head>
  	...
  	<body background="${path}/img/picture3.jpg">
		...
		<form action="${path}/source/update.action" method="post">
			...
			<div class="usermanage_hang">
				...
				<input type="text" name="type"  value="${source.type}" class="input_update" />
			</div>
			<div class="usermanage_hang">
				<div class="huiyishi_left">空闲个数</div>
				<input type="text" name="free" value="${source.free}"  class="input_update"  />
			</div>
			<div class="usermanage_hang">
				<div class="huiyishi_left">使用个数</div>
				<input type="text" name="availabe" value="${source.availabe}"  class="input_update"  />
			</div>
