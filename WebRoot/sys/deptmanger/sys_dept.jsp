...
<html>
	<head>
  	...
  	<body background="${path}/img/picture3.jpg">
		...
		<script>
				$("#dg").datagrid({    
		    		url:"${path}/dept/selectPageUseDyc.action?time="+new Date().getTime(),    
		    		...
		    		toolbar: [
		    		 		   {
								  ...
								  text:"增加",
								  handler: function(){
									 window.location.href="/meetroom/sys/deptmanger/sys_dept_add.jsp";
							      }
							   },
							   {
								  iconCls: 'icon-edit',
								  text:"修改",
								  handler: function(){
								   	  var dept = $("#dg").datagrid("getSelected");
									  window.location.href="/meetroom/dept/updateUI.action?id="+dept.id;
								  }
							   },
							   {
								  iconCls: "icon-remove",
								  ...
								  handler: function(){
								      var dept = $("#dg").datagrid("getSelected");
									  window.location.href="/meetroom/dept/del.action?id="+dept.id;
								  }
							   },
							   {
